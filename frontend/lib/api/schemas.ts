...
const securityEventSchema = z.object({ stage: z.string(), risk: z.string(), action: z.string(), categories: z.array(z.string()) });
export const queryResponseSchema = z.object({
  ...
  usage: z.object({ dense_candidates: z.number().int(), sparse_candidates: z.number().int(), context_chunks: z.number().int() }), security: z.object({ action: z.string(), events: z.array(securityEventSchema) }), rewritten_queries: z.array(z.string())
});
